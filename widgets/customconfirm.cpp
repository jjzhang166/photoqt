...
CustomConfirm::CustomConfirm(QString title, QString text, QString yesText, QString noText, QSize size, QString borderColor, QWidget *parent) : MyWidget(borderColor,parent) {
